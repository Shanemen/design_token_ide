...
export default function Step3Motion({ state, dispatch }) {
  ...
  return (
    <div>
      ...
      {/* B. Rhythm & Feel */}
      <div style={{ marginTop: 24 }}>{subLabel("B. Rhythm & Feel")}</div>
      ...
      <div style={{ marginTop: 24 }}>{subLabel("C. Page Load Animation")}</div>
      <div style={{ marginBottom: 16 }}>
      ...
      {/* D. Scroll Animations */}
      <div style={{ marginTop: 24 }}>{subLabel("D. Scroll Triggered")}</div>
      <div style={{ marginBottom: 16 }}>
        <div style={{ display: "flex", gap: 8, marginBottom: 12 }}>
      ...
      {/* E. Hover Effects */}
      <div style={{ marginTop: 24 }}>{subLabel("E. Hover Effects")}</div>
      <div style={{ marginBottom: 16 }}>
        <div style={{ display: "flex", gap: 8, marginBottom: 12 }}>
      ...
      {/* F. Page Transitions */}
      <div style={{ marginTop: 24 }}>{subLabel("F. Page Transition")}</div>
      <div style={{ marginBottom: 16 }}>
        <label style={{
          display: "block",
          fontFamily: "'JetBrains Mono', monospace",
      ...
      <div style={{ marginTop: 24 }}>{subLabel("G. Micro-interactions")}</div>
