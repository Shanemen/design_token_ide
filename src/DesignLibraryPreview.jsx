...
// We receive ThemeContext from the parent via import
// But since ThemeContext is defined in DesignTokenTemplate, we'll accept theme as a prop
export default function DesignLibraryPreview({ tokens, openSections, selectedLayout, theme }) {
  ...
  const highlightStyle = (sectionIndex) => ({
    marginBottom: 28,
    padding: openSections[sectionIndex] ? 16 : 0,
    borderRadius: 12,
    border: openSections[sectionIndex] ? `1.5px solid ${t.accent}30` : "1.5px solid transparent",
    background: openSections[sectionIndex] ? `${t.accent}08` : "transparent",
